...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-white via-cyan-50 to-white">
        ...
        <div className="grid lg:grid-cols-2 items-center min-h-[72vh] lg:min-h-[74vh] gap-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-5 mt-10">
              <Link
                to="/shop"
                className="px-8 py-4 rounded-full bg-gradient-to-r from-cyan-500 to-teal-600 text-white font-semibold shadow-xl hover:scale-105 hover:shadow-2xl transition-all duration-300"
              >
                Shop Now
              </Link>
